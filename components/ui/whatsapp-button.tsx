...
const isBot = (): boolean => {
  ...
  return /bot|crawler|spider|scraper|curl|wget|python|java|php|headless|puppet|selenium|phantom|lighthouse/i.test(userAgent)
}
    ...
    <>
      <span className="hidden sm:flex flex-row items-center gap-2 p-1 cursor-pointer">
        <Image 
          ...
          className="w-8 h-8"
        />
        <span className="font-medium pr-1">Escríbenos</span>
      </span>
