  ...
  "inline-flex items-center justify-center cursor-pointer text-sm font-semibold uppercase tracking-wider ring-offset-background transition-all duration-200 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 rounded-xs",
  {
    variants: {
      variant: {
        ...
        outline:
          "border-3 border-accent bg-white font-bold text-accent shadow-[0_1px_2px_0_rgb(0_0_0_/_0.05)] hover:bg-accent/8 hover:border-accent hover:text-accent hover:shadow-[0_4px_6px_-1px_rgb(0_0_0_/_0.1),0_2px_4px_-2px_rgb(0_0_0_/_0.1)] hover:-translate-y-0.5 active:translate-y-0 active:shadow-[0_1px_2px_0_rgb(0_0_0_/_0.05)]",
        secondary:
